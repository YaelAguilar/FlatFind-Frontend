      ...
      setSearchTimeout(
        setTimeout(async () => {
          const { data } = await axiosInstance.get(
            `/places/search/${searchText.trimStart()}`,<img class="h-8 w-8 md:h-10 md:w-10" src="https://img.icons8.com/external-others-cattaleeya-thongsriphong/64/external-Motel-locations-color-line-others-cattaleeya-thongsriphong.png" alt="external-Motel-locations-color-line-others-cattaleeya-thongsriphong"></img>
          );
          setPlaces(data);
          setLoading(false);
        }, 500),
