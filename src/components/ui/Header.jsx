      ...
      >
        <a href="/" className="flex items-center gap-1">
          <img
            ...
            src="https://img.icons8.com/external-others-cattaleeya-thongsriphong/64/external-Motel-locations-color-line-others-cattaleeya-thongsriphong.png"
            alt="external-Motel-locations-color-line-others-cattaleeya-thongsriphong"
          />
